...
export class DiolougeService {
    dialogComponentRef: ComponentRef<DiolougeCompComponent>;
  ...
  constructor( private componentFactoryResolver: ComponentFactoryResolver, private appRef: ApplicationRef, private injector: Injector) { }
    ...
    const componentFactory = this.componentFactoryResolver.resolveComponentFactory(DiolougeCompComponent);
